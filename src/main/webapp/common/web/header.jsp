    ...
    <div class="row navbar">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <security:authorize access="isAnonymous()">
                    <li class><a class="nav-link" href="<c:url value='/login'/>">Đăng nhập</a></li>
                    <li class="nav-item"><a class="nav-link" href="<c:url value='/signup'/>">Đăng ký</a></li>
                </security:authorize>
                <security:authorize access="isAuthenticated()">
                    <security:authorize access="hasRole('MANAGER')">
                        <li class="nav-item"><a class="nav-link" href="/admin/home"> Xin chào Admin <%=SecurityUtils.getPrincipal().getUsername()%></a></li>
                    </security:authorize>
                     <security:authorize access="hasRole('STAFF')">
                        <li class="nav-item"><a class="nav-link" href="/admin/home"> Xin chào nhân viên <%=SecurityUtils.getPrincipal().getUsername()%></a></li>
                    </security:authorize>
